-- Fix user roles and create complete dummy data for Andrew's Clinic
-- Run this in Supabase SQL Editor

-- First, find the user ID for todays777@gmail.com
SELECT id, email FROM auth.users WHERE email = 'todays777@gmail.com';

-- Add super admin role for todays777@gmail.com (if not already exists)
-- Replace 'USER_ID_HERE' with the actual user ID from the query above
INSERT INTO user_roles (user_id, org_id, role, created_by) VALUES
('cfe96e06-7866-4b95-8c69-d0e30b2c8b2f', NULL, 'super_admin', 'cfe96e06-7866-4b95-8c69-d0e30b2c8b2f'),
('cfe96e06-7866-4b95-8c69-d0e30b2c8b2f', 'bf579a76-e9c5-45be-8659-7e62664883c4', 'org_admin', 'cfe96e06-7866-4b95-8c69-d0e30b2c8b2f')
ON CONFLICT (user_id, COALESCE(org_id, '00000000-0000-0000-0000-000000000000'), role) DO NOTHING;
