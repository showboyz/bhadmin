...
import { RefreshCw, TrendingUp, TrendingDown, Minus, Building2 } from 'lucide-react'
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-600">
              Hello {user?.user_metadata?.name || user?.email?.split('@')[0] || 'admin'}, 
              here's your {organization?.org_type || 'organization'} dashboard overview
            </p>
          </div>
          <Button 
            variant="outline" 
